...
@implementation AssetWriter

//WCLRecordEncoder遍历构造器的
+ (AssetWriter*)encoderForPath:(NSString*) path Height:(NSInteger) cy width:(NSInteger) cx channels: (int) ch samples:(Float64) rate {
    AssetWriter* enc = [AssetWriter new];
