...
//  RoomSource
//
//  Created by wangxiaoli on 2018/7/3.
...
@interface QKRunScrollLabel : UIView
...
//滚动速率，默认为37.5(pt/s)。赋值必须大于0，否则速率默认为37.5
...
@property (nonatomic, assign) ZScrollLabelAlignment labelAlignment;
